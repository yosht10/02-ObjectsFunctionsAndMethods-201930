...
def turtle_thing(color, thickness):
    window = rg.TurtleWindow()

    #window.delay(20)

    #window.pen = rg.Pen("green", thickness)
    tae = rg.SimpleTurtle()
    tae.pen = rg.Pen("green", thickness)
    tae.forward(100)

    yoshi = rg.SimpleTurtle()
    yoshi.pen = rg.Pen(color, 5)
    yoshi.backward(100)
