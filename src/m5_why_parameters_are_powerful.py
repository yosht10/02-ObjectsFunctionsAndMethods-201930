...
def main():
    ...
    #even_better_draw_circles(point, r, number, color, thickness)
    even_better_draw_circles(rg.Point(100, 50), 5, 10, 'blue', 1)
    even_better_draw_circles(rg.Point(-200, 0), 5, 15, 'green', 2)
